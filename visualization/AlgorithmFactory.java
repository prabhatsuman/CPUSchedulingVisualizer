...
public class AlgorithmFactory {
    ...
    public static SchedulingAlgorithm createAlgorithm(String algorithmName, List<ProcessImp> processList, int quantum) {
        ...
        switch (algorithmName.toLowerCase()) {
            ...
            case "round robin":
                return new RoundRobinAlgorithm(processStore, processList.size(), quantum);
            default:
